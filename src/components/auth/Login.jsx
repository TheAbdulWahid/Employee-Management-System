...
const Login = (props) => {
  ...
  return (
    <div className="flex justify-center items-center h-screen flex-col gap-[50px]">
      <h1 className="text-[50px] font-bold uppercase mx-auto w-[850px] text-center leading-[1.2]">
        Welcome to Employee Management System (EMS) App
      </h1>
        ...
        <form className="flex flex-col gap-[30px] h-[400px] justify-center">
          <div className="email-container flex flex-col gap-[10px]">
            ...
            <input
              ...
              className="border-1 px-[25px] py-[20px] rounded-full text-white outline-0"
              required
              autoComplete="true"
            />
          </div>
          ...
          <button
            className="bg-white text-black font-medium text-[18px] px-[25px] py-[20px] rounded-full"
            onClick={Submission}
          >
            Login
          </button>
